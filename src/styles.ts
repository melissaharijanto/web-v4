export const styles = {
    ...
    'transparent-button':'border-[1px] text-black border-white border-[1px] transition-all ease-in hover:font-bold',
    'blue-button':'border-[1px] text-black border-blue bg-blue hover:bg-blue-pressed hover:border-blue-pressed transition-all ease-in hover:font-bold',
    'button-with-right-arrow':'pl-4 pr-2 py-2 rounded-3xl gap-x-1 flex items-center justify-between',
